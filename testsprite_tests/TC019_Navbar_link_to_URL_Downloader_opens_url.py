...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'URL Downloader' navbar link (interactive element index 37) to navigate to the URL downloader page.
        ...
        download_link = frame.locator('xpath=/html/body/div[1]/div/nav/div/div/div[1]/a[3]')
